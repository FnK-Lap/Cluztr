...
class SentCluztTableViewCell: UITableViewCell {
    var cluzt: JSON?
    ...
    func initUI(cluzt:JSON) {
        ...
        for (key, value) in self.cluzt!["receiver"]["usersId"] {
        ...
        for (key, user) in self.cluzt!["sender"]["usersId"] {
